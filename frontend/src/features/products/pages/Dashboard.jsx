    ...
    <div className="bg-[#131313] text-[#e5e2e1] min-h-screen selection:bg-[#ffd700] selection:text-[#3a3000]">
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto w-full flex-1 flex flex-col">
          ...
          <header className="mb-16 md:mb-24 mt-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div>
                <span className="text-[0.75rem] text-[#d0c6ab] uppercase tracking-[0.3em] font-bold mb-4 block">
                  {sellerProducts[0]?.sellerId.fullname}
                </span>
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-[#fff6df]">
              ...
              {sellerProducts?.length > 0 && (
                <div className="flex items-center space-x-6 text-[#d0c6ab]">
                  <div className="text-right">
                    <span className="text-[0.75rem] uppercase tracking-widest block opacity-50 mb-1">
                      Active Listings
                    </span>
                    <span className="text-2xl font-medium text-[#fff6df]">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-2xl font-medium text-[#dbc677]">
                      Diamond
                    </span>
                  </div>
                </div>
          ...
          <section className="flex-1">
            {sellerProducts && sellerProducts.length > 0 ? (
                ...
                {sellerProducts.map((product) => (
                  <article key={product._id} className="group cursor-pointer">
                    <div
                      ...
                      className="relative aspect-[3/4] overflow-hidden rounded-xl bg-[#1c1b1b] mb-6 transition-all duration-500 group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-transparent group-hover:border-[#4d4732]/20"
                    >
                      {product.images && product.images.length > 0 ? (
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center text-[#999077] gap-3">
                          ...
                          <span className="text-[0.65rem] uppercase tracking-widest font-bold opacity-50">
                            No Image
                          </span>
                        </div>
                      )}
              ...
              <div className="w-full py-32 flex flex-col items-center justify-center bg-[#1c1b1b]/30 rounded-3xl border border-[#4d4732]/20 shadow-2xl backdrop-blur-sm relative z-10">
                <span className="material-symbols-outlined text-5xl text-[#4d4732] mb-6 drop-shadow-md">
                  inventory_2
                </span>
                <h2 className="text-[#d0c6ab] tracking-widest uppercase text-sm font-bold mb-3">
                  The Archive is Empty
                </h2>
                <p className="text-[#999077] text-xs max-w-sm text-center mb-10 leading-relaxed">
                  You have not curated any items yet. Begin building your luxury
                  collection to display artifacts here.
                </p>
                <button
                  onClick={() => navigate("/seller/create-product")}
      ...
      <footer className="p-8 text-center relative z-10 border-t border-[#1c1b1b] bg-[#131313] font-manrope">
        <p className="text-[0.6rem] uppercase tracking-[0.5em] text-[#999077] opacity-40">
          The Luxe Standard © {new Date().getFullYear()}
        </p>
      </footer>
    </div>
  );
