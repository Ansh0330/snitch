    ...
    <div className="bg-[#131313] text-[#e5e2e1] selection:bg-[#ffd700] selection:text-[#705e00] min-h-screen flex flex-col font-manrope">
      ...
      <header className="w-full top-0 sticky bg-[#131313] z-50">
        <div className="flex justify-between items-center px-8 py-6 w-full max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-8">
            ...
            <button className="bg-[#ffd700] text-[#3a3000] px-8 py-3 rounded-full font-manrope text-[0.75rem] uppercase tracking-widest font-bold hover:opacity-90 transition-all scale-95 active:opacity-80 cursor-pointer">
              Save Draft
            </button>
          </div>
        </div>
      ...
      <main className="flex-grow flex flex-col items-center px-6 py-12 md:py-24 relative overflow-hidden">
        ...
        <div className="w-full max-w-4xl mb-20 text-center md:text-left relative z-10">
          <span className="text-[0.7rem] uppercase tracking-[0.4em] text-[#999077] mb-4 block">
            New Exhibition Entry
          </span>
          <h1 className="text-5xl md:text-7xl font-extralight tracking-tighter text-[#fff6df] leading-tight">
            Curate Your <br />{" "}
            <span className="italic font-serif opacity-80">Masterpiece</span>
          </h1>
        </div>
        ...
        <form
          ...
          className="w-full max-w-4xl space-y-24 pb-32 relative z-10"
        >
          {/* Section 1: Core Identity */}
          <section className="space-y-12">
            <div className="group relative">
              <label className="text-[0.65rem] uppercase tracking-widest text-[#d0c6ab] font-bold absolute -top-6 left-0 opacity-60 group-focus-within:opacity-100 transition-opacity">
                Product Title
              </label>
              <input
                type="text"
          ...
          <section className="space-y-8">
            <div className="flex justify-between items-end">
              <h2 className="text-[0.75rem] uppercase tracking-widest text-[#d0c6ab] font-medium">
                Visual Gallery (0/7)
              </h2>
              <span className="text-[0.6rem] text-[#999077] italic">
                High-resolution recommended (min 2000px)
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-[160px] gap-4">
              ...
              >
                {images[0] ? (
                  ...
                  <>
                    <span className="material-symbols-outlined text-4xl text-[#999077] mb-4 group-hover:text-[#ffd700] transition-colors">
                      add_photo_alternate
                    </span>
                    <p className="text-[0.7rem] uppercase tracking-tighter text-[#999077] group-hover:text-[#e5e2e1]">
                      Primary Perspective
                    </p>
                  </>
                )}
                ...
                return (
                  ...
                  >
                    {imageFile ? (
                      ...
                      <span className="material-symbols-outlined text-[#999077] group-hover:text-[#ffd700]">
                        add
                      </span>
                    )}
                  </div>
          ...
          <section className="max-w-md">
            <div className="group relative">
              ...
              <div className="flex items-center gap-4 bg-[#1c1b1b] rounded-xl px-6 py-4 focus-within:ring-1 ring-[#ffd700]/40 transition-all">
                ...
                >
                  <option value="USD" className="bg-[#131313]">
                    USD
                  </option>
                  <option value="EUR" className="bg-[#131313]">
                    EUR
                  </option>
                  <option value="GBP" className="bg-[#131313]">
                    GBP
                  </option>
                  <option value="INR" className="bg-[#131313]">
                    INR
                  </option>
                </select>
          ...
          <section className="pt-12 border-t border-[#4d4732]/30 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-[#2a2a2a] flex items-center justify-center shrink-0">
                <span className="material-symbols-outlined text-[#ffd700] text-sm">
                  info
                </span>
              </div>
              <div>
                <p className="text-xs text-[#e5e2e1] font-medium uppercase tracking-widest mb-1.5">
                  Submission Standards
                </p>
                <p className="text-[0.65rem] text-[#999077] max-w-[240px] leading-relaxed">
                  All luxury items undergo a 24-hour verification process to
      ...
      <footer className="p-8 text-center relative z-10 border-t border-[#4d4732]/10 mt-auto">
        <p className="text-[0.6rem] uppercase tracking-[0.5em] text-[#999077] opacity-40">
          The Luxe Standard © 2024
        </p>
      </footer>
    </div>
  );
